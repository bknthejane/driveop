    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    FleetNumber = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JobCards_Incidents_IncidentId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_JobCards_Supervisors_AssignedSupervisorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobCards_AssignedSupervisorId",
                table: "JobCards",
                column: "AssignedSupervisorId");

            migrationBuilder.CreateIndex(
                name: "IX_JobCards_IncidentId",
                table: "JobCards",
                column: "IncidentId",
                unique: true);
